...
- [x] 2.10 Medir cache hit/miss en L1/L2 con `perf stat -e L1-dcache-load-misses,L1-icache-load-misses` sobre la prueba de estrés. (Parcial: `perf` instalado y tests creados. Los eventos hardware de caché no están disponibles en contenedor sin PMU; se usan eventos software como fallback. Para mediciones reales de L1/L2 hit/miss se requiere bare metal.)
