...
|---|---|---|---|
| pp tokens/seg | 117.50 | 0.581 | 0.005x |
| tg tokens/seg (1 thread) | 14.42 | 0.564 | 0.039x |
| tg tokens/seg (4 threads) | 14.42 | 2.24 | 0.155x |
| Ops/seg (1 thread) | — | 594M | — |
| Ops/seg (4 threads) | — | 1,957M | 3.35x scaling |
